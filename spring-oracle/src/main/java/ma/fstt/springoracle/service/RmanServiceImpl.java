...
public class RmanServiceImpl implements RmanService {
    ...
    public String performFullBackup() {
        ...
        try {
            ...
            String command = "docker exec  OracleDB_23ai rman target / cmdfile=/tmp/backup_script.rman";
    ...
    public String performIncrementalBackup(int level) {
        ...
        try {
            ...
            // Command to execute the RMAN script inside the Docker container
            String command = "docker exec  OracleDB_23ai rman target / cmdfile=" + scriptFile;
    ...
    public String performRestore() {
        ...
        try {
            ...
            String rmanCommand = "docker exec  OracleDB_23ai rman target / cmdfile=/tmp/restore_script.rman";
...
//            String sqlCommand = "docker exec -i spring-oracle-oracle-1 sqlplus / as sysdba @/tmp/oracle-db.sql";
            String sqlCommand = "docker exec -i  OracleDB_23ai sqlplus / as sysdba cmdfile=/tmp/oracle-db.sql";
//            String sqlCommand = "docker exec -i spring-oracle-oracle-1 sqlplus \"/ as sysdba\" @/tmp/oracle-db.sql";
